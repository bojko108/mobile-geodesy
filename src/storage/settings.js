...
export const DEFAULT_CRS = {
    ...
    type: 'dropdown',
    options: [
        { label: 'WGS84 Geographic coordinates', value: 'WGS84' },
        { label: 'WGS84 UTM 34 North', value: 'UTM34N' },
        { label: 'WGS84 UTM 35 North', value: 'UTM35N' },
...
export const FEATURE_TEMPLATES_URL = {
    ...
    description: 'Sets the URL address to a JSON file with feature templates. These templates contain all feature types and their attributes which can be collected using this app (requires restart).',
    visible: true,
    editable: true,
